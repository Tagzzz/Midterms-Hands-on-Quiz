...
const routes: Routes = [{path:'employee-list 1', component:Emplist1Component},
{path:'employee-list 2', component:Emplist2Component},
{path:'employee-list 3', component:Emplist3Component}];
